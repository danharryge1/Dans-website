...
export const about = {
  ...
  paragraphs: [
    ...
    "The obsession got serious with NextUp.co, my consultancy company. I got so deep into the site I almost forgot I was supposed to be running the business. When I found myself caring that much about getting every detail exactly right, I knew this was the thing. Obsessive attention to detail is my biggest strength and my most time consuming flaw. I am fine with both.",
  ],
  facts: [
    { id: "age", label: "AGE 20", caption: "from Wakefield" },
    { id: "study", label: "LJMU", caption: "BSc Applied Entrepreneurship" },
    { id: "origin", label: "NEXTUP.CO", caption: "the project that started it all" },
